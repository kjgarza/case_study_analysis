...
#  ds<-ds[!(ds$project_name %in% c("SysMO DB","SilicoTryp","TRANSLUCENT","Noisy-Strep")),]  
  ...
  sp + facet_grid(project_name ~ . , scales="free_y")  + geom_vline(xintercept = as.numeric(eval11), linetype=5) + geom_vline(xintercept = as.numeric(eval12), linetype=5) + geom_vline(xintercept = as.numeric(eval13), linetype=5)  
  
  #All aggregated
  # sp  + geom_vline(xintercept = as.numeric(eval11), linetype=5) + geom_vline(xintercept = as.numeric(eval12), linetype=5) + geom_vline(xintercept = as.numeric(eval13), linetype=5)  + theme(text = element_text(size=18, family="serif"))
